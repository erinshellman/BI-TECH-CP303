...
Exploratory data analysis (EDA) is a the second step of the data mining process, 
...
Add a table of useful operators. + - * / %% ^

### Slicing and dicing

Dataframes are indexed `df[row, col]`.  Leaving either the `row` or `col` 
...
Sometimes it's faster and easier to get help with Google. The first setp of my 
